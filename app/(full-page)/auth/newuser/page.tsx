        ...
        loginService.novoCadastro(usuario).then((response) => { 
            ...
            console.log(error)
                toast.current?.show({
                    severity: 'error',
                    summary: 'Erro!',
                    detail: 'Erro ao cadastrar usuário!' + error
                })
        });
    }
                ...
                >
                    <div className="w-full surface-card py-8 px-5 sm:px-8" style={{ borderRadius: '53px' }}>
                        <div className="text-center mb-5">
                            ...
                            <div className="text-900 text-3xl font-medium mb-3">Cadastre-se</div>
                            {/* <span className="text-600 font-medium">Faça seu cadastro</span> */}
                        </div>
